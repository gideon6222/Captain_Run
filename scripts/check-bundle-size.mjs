/* Bundle size guard.
   ...
   A module split in the other game here once dropped
   requestAnimationFrame(frame) from the entry point. Every golden test passed,
   the typecheck was clean, the build succeeded, and the game was frozen. The
   only signal was the bundle getting 7463 bytes smaller, because everything
   reachable solely from the frame loop had been tree-shaken away as
   unreachable. This game is mid-split, which is exactly when that happens.
